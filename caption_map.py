...
def generate_caption_map(captionjsonpath):
    ...
    mscoco_imageid = [entry['image_id'] for entry in mscoco['annotations']] #id is the coco id
...
if __name__ == '__main__':
    #mscoco_caption_path = "K:/Masud/2017Spring/Vision/language_generation_lab/annotations/captions_train2014.json"
    mscoco_caption_path = "K:/Masud/2017Spring/Vision/language_generation_lab/annotations/captions_val2014.json"
    cap_map = generate_caption_map(mscoco_caption_path)
